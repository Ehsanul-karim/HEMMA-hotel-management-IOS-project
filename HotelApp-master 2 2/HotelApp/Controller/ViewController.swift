...
class ViewController: UIViewController {
    ...
    var backgroundImage: UIImageView = {
        let image = UIImageView(image: UIImage(named: "hotel_afiat"))
        image.contentMode = .scaleAspectFill
        image.translatesAutoresizingMaskIntoConstraints = false
        return image
    }()
//    let roundedImageView: UIImageView = {
//            let imageView = UIImageView(image: UIImage(named: "hotel_back_img"))
...
//        }()
    ...
    func setupConstraints() {
        ...
        view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-\(view.frame.height / 9.0)-[v0(36)]-190-[v1(100)]", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":titleLabel,"v1":descriptionLabel]))
