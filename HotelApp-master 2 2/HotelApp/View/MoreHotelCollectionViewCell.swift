...
//        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|[v0]|", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":hotelImage]))
        ...
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|[v0(\(widthvalue))]-20-[v1(90)]", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":hotelImagesView,"v1":roomLabel]))
